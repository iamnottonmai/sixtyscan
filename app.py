...
<div class='card'>
    <h2>1. สระ</h2>
    <p class='instructions'>กรุณาออกเสียงแต่ละสระ 5-8 วินาทีอย่างชัดเจน โดยกดปุ่มบันทึกที�[...]
</div>
""", unsafe_allow_html=True)
...
<div class='card'>
    <h2>3. ประโยค</h2>
    <p class='instructions'>กรุณาอ่านประโยค "วันนี้อากาศแจ่มใสนกร้องเสียงดังเป็นจังหวะ"</p>
</div>
""", unsafe_allow_html=True)
